...
architecture IMP of user_logic is
  ...
  signal v_sync_counter      : std_logic_vector(31 downto 0);
...
begin
      ...
      tc_en            <= '0';
        ...
        if (reg_we = '1') then
          case (unit_addr) is
            ...
            when REG_ADDR_07 => v_sync_counter   <= Bus2IP_Data(31 downto 0);
            when REG_ADDR_08 => tc_en            <= Bus2IP_Data(0);
            when others => null;
          end case;
        end if;
    end if;
  ...
  tc_s <= '1' when dir_pixel_row = v_sync_counter else
         '0';
         
  IRQ_o <= tc_s and tc_en;
